...
#Block to keep the script running then sleep for time 300.0 with counter set at 72 for Games every 5min | Odds every 6hr.
counter=72
startTime = time.time()
while True:
    ...
    print('\n')
    time.sleep(360.0 - ((time.time() - startTime) % 300.0))